...
class Qingxin extends StatefulWidget {
  @override
  _QingxinState createState() => _QingxinState();
}

class _QingxinState extends State<Qingxin> with AutomaticKeepAliveClientMixin {
  @override
  void initState() {
